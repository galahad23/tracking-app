...
public class FacebookLoginJob extends BaseJob {
    ...
    public FacebookLoginJob(User user, int hashCode) {
    ...
    public void onRun() throws Throwable {
        ...
        Call<APIResult> call = taskService.facebookLogin(user.getFacebookId(),
        ...
        if (execute.isSuccessful()) {
            ...
            if (result.getSuccess().equalsIgnoreCase(Constants.APIStatus.SUCCESS)) {
                ...
                EventBusUtil.post(new AccountEvent.OnFacebookLogin(hashCode));
