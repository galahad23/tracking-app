...
public class ChipLayout extends ViewGroup implements View.OnClickListener {
    ...
    private AutoCompleteTextView createAutoCompleteTextView(final Context context)
    {
        final LayoutParams lparamsTextView = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        lparamsTextView.setMargins(5, 0, 10, 0);
        ...
        autoCompleteTextView.setHint("Track Zone");
        autoCompleteTextView.setHintTextColor(Color.parseColor("#ddddde"));
        autoCompleteTextView.setTextSize(13);
        autoCompleteTextView.setPadding(4, 0, 4, 4);
        autoCompleteTextView.setTextSize(13);
        autoCompleteTextView.setSingleLine(true);
        autoCompleteTextView.setTextColor(Color.parseColor("#262b46"));
    ...
    private ViewGroup createChips(Context context, String val, boolean setText)
    {
        ...
        if(textSize > 0){
            autoCompleteTextView.setTextSize(13);
            ((ChipTextWatcher)textWatcher).setTextSize(13);
        }
