...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userFunction = new User_function();
...
*/
    ...
    protected void onResume() {
        ...
        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            ...
            if (getLocationMode(Splash.this) != 3) {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (userFunction.isUserLoggedIn(getApplicationContext())) {
                                        // for start service
                                        startService(new Intent(Splash.this, CurrentLocationService.class));
    ...
    public void onRequestPermissionsResult(int requestCode, final String[] permissions, int[] grantResults) {
        AndroidPermissions.result(Splash.this)
