package com.example.android.vcare.phonefield;
...
public class CountriesAdapter extends ArrayAdapter<Country> implements SpinnerAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    countryCode = (TextView)convertView.findViewById(R.id.countryCode);


    countryCode.setText(String.valueOf(country.getDialCode()));
