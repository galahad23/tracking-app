...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 80000; // 10 meters

    // The minimum time between updates in milliseconds
    private static final long MIN_TIME_BW_UPDATES = 80000;
